...
public class LineUpSwerveConeUpright extends CommandBase {
	 ...
	 */
	public LineUpSwerveConeUpright(Claw claw, SwerveSubsystem swerve) {
		this.claw = claw;
		this.swerve = swerve;
	...
	public void initialize() {
        ...
        pidY.calculate(NetworkTables.getPalmCenter("Cone")[1], 220);
	}
	...
	public void execute() {
        ...
        if(CuboneManager.isSomethingInBound()) {
				...
				if(CuboneManager.isConeInbound()) {
            		...
            		ySpeed = pidY.calculate(NetworkTables.getPalmCenter("Cone")[1], 220);
				}
